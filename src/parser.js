...
const DIMENSIONS = {
  ...
  career: {
    keywords: [
      ...
      'mentor', 'networking event', 'conference', 'workshop', 'webinar',
      'productivity', 'focus', 'deep work', 'shipped', 'delivered'
    ],
    positive: [
  ...
  family: {
    keywords: [
      ...
      'daughter', 'baby', 'toddler', 'family', 'home', 'homework',
 ...
 * Returns ISO 4217 code. Defaults to USD if no currency detected.
 */
function detectCurrency(text) {
  ...
  return null; // no currency detected — will use user's base currency
}
